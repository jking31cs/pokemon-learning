...
/**
 * Class that runs the next move Analysis.  This looks at all pokemon in the "PokemonToAnalyze" file and determines
 * which move they should use against specific pokemon opponents and the confidence that it'll lead to their team
 * winning the match.
 */
public class NextMoveAnalysis {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final BlockingDeque<String> queue = new LinkedBlockingDeque<>(GetPokemonToAnalyze.get());
